---
layout: post
title: Fun with flags (in Slack)
---

This post is about a pet trolling I do in Slack, and I thought I'd share with the world.
...
* 🇺🇾 (Uruguay) instead of 🇬🇷 (Greece)
* 🇵🇫 (French polynesia) instead of 🇦🇹 (Austria)
...
![flagrolling-austria]({{ site.baseurl }}/images/flagrolling-austria.png)

#### Philippines 🇵🇭 instead of Czech Republic 🇨🇿

![flagrolling-czech]({{ site.baseurl }}/images/flagrolling-czech.png)

#### Norway 🇳🇴 instead of Iceland 🇮🇸

![flagrolling-iceland]({{ site.baseurl }}/images/flagrolling-iceland.png)

#### Morocco 🇲🇦 instead of Vietnam 🇻🇳

![flagrolling-vietnam]({{ site.baseurl }}/images/flagrolling-vietnam.png)

### Credits

Thanks a lot to [George Stefanis](https://www.georgestefanis.com/) for the idea to create this post and for proofreading it.